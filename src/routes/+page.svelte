...
<div class="flex flex-col items-center pt-32">
	<h1 class="h1">
		<span class="gradient-heading text-2xl md:text-3xl lg:text-6xl"> Slogan lorem ipsum dolor </span>
	</h1>
	<h1 class="h1">
...
<div class="flex flex-col items-center px-7 md:px-40 lg:px-60 xl:px-96 pt-32">
